...
Monster::Monster(string name, string description, int healthPoints, int defence):
	Creature(name, description, healthPoints, defence)
{
}

Monster::Monster(string name, string description, int healthPoints, int defence, vector<Item*> loot):
	Creature(name, description, healthPoints, loot, defence)
{
}

Monster::Monster(string name, string description, int healthPoints, vector<Attack*> attacks, int defence):
	Creature(name, description, healthPoints, attacks, defence)
{
}

Monster::Monster(string name, string description, int healthPoints, vector<Attack*> attacks, int defence, vector<Item*> loot) :
	Creature(name, description, healthPoints, attacks, loot, defence)
{
}
